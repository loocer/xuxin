      ...
      Manager.prototype.reconnect = function () {
        ...
        if (this.attempts > this._reconnectionAttempts) {
          ...
          var timer = setTimeout(function () {
            ...
            self.emitAll('reconnecting', self.attempts); // check again for the case socket closed in above events
    ...
    6: [function (_dereq_, module, exports) {
      (function (global) {
        ...
        function url(uri, loc) {
          ...
          if (null == uri) uri = loc.protocol + '//' + loc.hostname; // relative path support
          ...
          obj.path = obj.path || '/'; // define unique id
      ...
      (function (global) {
        ...
        */
        ...
        Socket.prototype.onDrain = function () {
          ...
          this.callbackBuffer.splice(0, this.prevBufferLen); // setting prevBufferLen = 0 is very important
        ...
        Socket.prototype.onClose = function (reason, desc) {
          if ('opening' == this.readyState || 'open' == this.readyState || 'closing' == this.readyState) {
            ...
            clearTimeout(this.pingTimeoutTimer); // clean buffers in next tick, so developers can still
            ...
            }, 0); // stop event from firing again for transport
    ...
    27: [function (_dereq_, module, exports) {
      (function (global) {
        ...
        (function (root) {
          ...
          var stringFromCharCode = String.fromCharCode; // Taken from http://mths.be/punycode
          ...
          function utf8encode(string) {
            var codePoints = ucs2decode(string); // console.log(JSON.stringify(codePoints.map(function(x) {
