...
function (module, exports, __webpack_require__) {
  ...
  function inject() {
    ...
    if (global.sharedCanvas) {
      ...
      sharedCanvas.__proto__.__proto__ = new _HTMLElement2.default('canvas'); // eslint-disable-next-line no-undef

      sharedCanvas.addEventListener = _window.addEventListener; // eslint-disable-next-line no-undef
