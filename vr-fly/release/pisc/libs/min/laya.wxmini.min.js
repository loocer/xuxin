window.wxMiniGame = function (e, t) {
  ...
  class i {
    ...
    static downOtherFiles(e, t = null, n = "", a = !1, o = !0) {
      i.wxdown({
        url: e,
        success: function (e) {
          200 === e.statusCode ? (l.autoCacheFile || a) && -1 == n.indexOf("qlogo.cn") && -1 == n.indexOf(".php") ? (null != t && t.runWith([0, e.tempFilePath]), i.copyFile(e.tempFilePath, n, null, "", o)) : null != t && t.runWith([0, e.tempFilePath]) : null != t && t.runWith([1, e]);
        },
        fail: function (e) {
    ...
    static copyFile(e, n, a, o = "", s = !0) {
      ...
      c ? c.readyUrl != n ? i.fs.getFileInfo({
        filePath: e,
        success: function (t) {
          s && f + 4194304 + t.size >= 52428800 && (t.size > l.minClearSize && (l.minClearSize = t.size), i.onClearCacheRes()), i.deleteFile(e, n, a, o, t.size);
        },
        fail: function (e) {
        ...
        filePath: e,
        success: function (t) {
          s && f + 4194304 + t.size >= 52428800 && (t.size > l.minClearSize && (l.minClearSize = t.size), i.onClearCacheRes()), i.fs.copyFile({
            srcPath: e,
            destPath: h,
            success: function (e) {
    ...
    static onSaveFile(e, n, a = !0, o = "", s = null, r = 0) {
      ...
      if (null == i.filesListObj.fileUsedSize && (i.filesListObj.fileUsedSize = 0), a) {
        ...
        i.filesListObj.fileUsedSize = parseInt(i.filesListObj.fileUsedSize) - d, i.fakeObj[l].md5 == i.filesListObj[l].md5 && delete i.fakeObj[l], delete i.filesListObj[l], i.writeFilesList(l, JSON.stringify(i.filesListObj), !1), null != s && s.runWith([0]);
      }
    }
  ...
  i.fs = window.wx.getFileSystemManager(), i.wxdown = window.wx.downloadFile, i.filesListObj = {}, i.fakeObj = {}, i.fileListName = "layaairfiles.txt", i.ziyuFileData = {}, i.ziyuFileTextureData = {}, i.loadPath = "", i.DESCENDING = 2, i.NUMERIC = 16;

  class n extends t.SoundChannel {
    constructor(e, t) {
      super(), this._audio = e, this._miniSound = t, this._onEnd = n.bindToThis(this.__onEnd, this), e.onEnded(this._onEnd);
    }
    ...
    stop() {
      this.isStopped = !0, t.SoundManager.removeChannel(this), this.completeHandler = null, this._audio && (this._audio.stop(), this.loop || (this._audio.offEnded(null), this._miniSound.dispose(), this._audio = null, this._miniSound = null, this._onEnd = null));
    }
  ...
  class a extends t.EventDispatcher {
    ...
    load(e) {
      ...
      if (this.url = e, this.readyUrl = e, a._audioCache[this.readyUrl]) this.event(t.Event.COMPLETE);else if (l.autoCacheFile && i.getFileInfo(e)) this.onDownLoadCallBack(e, 0);else if (l.autoCacheFile) {
        if (i.isLocalNativeFile(e)) {
          var o = e;
          if ("" != (n = "" != t.URL.rootPath ? t.URL.rootPath : t.URL._basePath) && (e = e.split(n)[1]), e || (e = o), l.subNativeFiles && 0 == l.subNativeheads.length) for (var s in l.subNativeFiles) {
        ...
        } else !i.isLocalNativeFile(e) && -1 == e.indexOf("http://") && -1 == e.indexOf("https://") || -1 != e.indexOf("http://usr/") ? this.onDownLoadCallBack(e, 0) : i.downOtherFiles(e, t.Handler.create(this, this.onDownLoadCallBack, [e]), e);
      ...
      if (n) this.event(t.Event.ERROR);else {
        ...
        if (l.autoCacheFile) {
          if (o) s = o;else if (i.isLocalNativeFile(e)) {
            var r = "" != t.URL.rootPath ? t.URL.rootPath : t.URL._basePath,
                d = e;
            "" == r || -1 == e.indexOf("http://") && -1 == e.indexOf("https://") || (s = e.split(r)[1]), s || (s = d);
          } else {
          ...
          this.url != t.SoundManager._bgMusic ? (this._sound = a._createSound(), this._sound.src = this.url = s) : (this._sound = a._musicAudio, this._sound.src = this.url = s);
        } else this.url != t.SoundManager._bgMusic ? (this._sound = a._createSound(), this._sound.src = e) : (this._sound = a._musicAudio, this._sound.src = e);
    ...
    play(e = 0, o = 0) {
      var s;
      if (this.url == t.SoundManager._bgMusic ? (a._musicAudio || (a._musicAudio = a._createSound()), s = a._musicAudio) : s = a._audioCache[this.readyUrl] ? a._audioCache[this.readyUrl]._sound : a._createSound(), !s) return null;
      ...
      var d = new n(s, this);
      return d.url = this.url, d.loops = o, d.loop = 0 === o, d.startTime = e, d.play(), t.SoundManager.addChannel(d), d;
    }
    ...
    dispose() {
      ...
      e && (e.src = "", e._sound && (e._sound.destroy(), e._sound = null, e = null), delete a._audioCache[this.readyUrl]), this._sound && (this._sound.destroy(), this._sound = null, this.readyUrl = this.url = null);
    }
  ...
  class o {
    ...
    static wxinputFocus(e) {
      ...
      i && !i.editable || (l.window.wx.offKeyboardConfirm(), l.window.wx.offKeyboardInput(), l.window.wx.showKeyboard({
        ...
        var n = e ? e.value : "";
        i._restrictPattern && (n = n.replace(/\u2006|\x27/g, ""), i._restrictPattern.test(n) && (n = n.replace(i._restrictPattern, ""))), i.text = n, i.event(t.Event.INPUT), o.inputEnter(), i.event("confirm");
      }), l.window.wx.onKeyboardInput(function (e) {
        var n = e ? e.value : "";
        i.multiline || -1 == n.indexOf("\n") ? (i._restrictPattern && (n = n.replace(/\u2006|\x27/g, ""), i._restrictPattern.test(n) && (n = n.replace(i._restrictPattern, ""))), i.text = n, i.event(t.Event.INPUT)) : o.inputEnter();
      }));
    }
  ...
  class s extends t.EventDispatcher {
    ...
    _loadSound(e) {
      ...
      if (i.isLocalNativeFile(e)) {
        var a = "" != t.URL.rootPath ? t.URL.rootPath : t.URL._basePath,
            o = e;
        "" == a || -1 == e.indexOf("http://") && -1 == e.indexOf("https://") || (n = e.split(a)[1]), n || (n = o), s.onDownLoadCallBack(e, this, 0);
      } else {
    ...
    static onReadNativeCallBack(e, i = null, n = null, a = 0, o = null) {
      var s;
      a ? 1 == a && n._loadHttpRequest(e, i, n, n.onLoaded, n, n.onProgress, n, n.onError) : (s = i == t.Loader.JSON || i == t.Loader.ATLAS || i == t.Loader.PREFAB || i == t.Loader.PLF ? l.getJson(o.data) : i == t.Loader.XML ? t.Utils.parseXMLFromString(o.data) : o.data, !l.isZiYu && l.isPosMsgYu && i != t.Loader.BUFFER && l.window.wx.postMessage({
        url: e,
        data: s,
        isLoad: "filedata"
      }), n.onLoaded(s));
    ...
    static _transformImgUrl(e, n, a) {
      if (l.isZiYu || i.isLocalNativeFile(e)) a._loadImage(e, !1);else if (l.autoCacheFile) {
        if (i.isLocalNativeFile(e) || i.getFileInfo(t.URL.formatURL(e))) s.onCreateImage(e, a);else {
          var o = t.URL.formatURL(e);
          -1 != e.indexOf(l.window.wx.env.USER_DATA_PATH) || -1 == o.indexOf("http://") && -1 == o.indexOf("https://") || l.isZiYu ? a._loadImage(e) : i.downOtherFiles(o, new t.Handler(s, s.onDownImgCallBack, [e, a]), o);
        }
      } else a._loadImage(e);
    }
  ...
  class l {
    ...
    static onMkdirCallBack(e, t) {
      e ? (i.fakeObj = {}, i.filesListObj = {}) : (i.filesListObj = JSON.parse(t.data), i.fakeObj = JSON.parse(t.data) || {}), i.fs.readdir({
    ...
    static postInfoToContext(e, n, a) {
      ...
      if (r) var d = r.md5,
          u = i.getFileNativePath(d);else u = s;
  ...
  e.MiniAccelerator = d, e.MiniAdpter = l, e.MiniFileMgr = i, e.MiniInput = o, e.MiniLoader = s, e.MiniLocalStorage = r, e.MiniLocation = u, e.MiniSound = a, e.MiniSoundChannel = n, e.MiniVideo = class {
